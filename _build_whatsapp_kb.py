...
RULES = (
    ...
    "• Use SPECIFIC categories — always prefix with 'WhatsApp: ':\n"
    "  'WhatsApp: Pilot Clients & Metrics', 'WhatsApp: Product Issues & Bugs',\n"
    "  'WhatsApp: Setup & Configuration', 'WhatsApp: Client Objections & Responses',\n"
    "  'WhatsApp: Feature Requests', 'WhatsApp: Sales Process',\n"
    "  'WhatsApp: Onboarding Learnings', 'WhatsApp: Bot Performance'.\n"
